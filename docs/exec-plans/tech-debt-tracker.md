...
| F-M25 | Split ChatArea.tsx (304 lines, exceeds 300-line limit) | frontend | 0.25d | done | PR #110 merged. Extracted useConversationWebSocket hook (304→190 lines). |
...
| F-M25 | Split ChatArea.tsx — extract useConversationWebSocket hook (PR #110) | 2026-02-27 |
